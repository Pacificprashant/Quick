...
const MovieCard = ({movie}) => {
    ...
    return(
        <div className="flex flex-col justify-center p-3 bg-gray-800 rounded-2xl
            ...
            object-right-bottom cursor-pointer hover:scale-105 transition duration-300 ease-in-out'
             />
             <p className='font-semibold mt-2truncate'>{movie.title}</p>
