            ...
            {booking.map((item,index) => (
                ...
                <div key={index} className="flex flex-col md:flex-row justify-between
                    ...
                    <div className="flex flex-col md:flex-row">
                        <img src={item.show.movie.poster_path} className="md:max-w-45 aspect-video h-auto object-cover
                    ...
                    <div className="flex flex-col md:items-end md:text-right justify-between p-4">
                        ...
                        <div className="text-sm">
                            <p><spna className="text-gray-400">Total ticket:</spna>
                            {item.bookedSeats.length}</p>
                            <p><spna className="text-gray-400">Seat Number:</spna>
